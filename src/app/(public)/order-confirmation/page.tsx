  ...
  return (
    <div className='max-w-xl mx-auto min-h-[60vh] flex flex-col items-center justify-center py-20 px-6'>
      ...
      <div className='mb-8 text-center text-gray-500 text-sm'>
        <strong>What&apos;s Next?</strong> We&apos;ll notify you when your order is shipped.
        <br />
        You can view your order status in your <span className='font-semibold'>My Orders</span>{' '}
        page.
      </div>
