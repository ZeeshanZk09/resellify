  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 min-h-[60vh]'>
        {users.length > 0 ? (
          users.map((user) => (
            <Card key={user.id} className={`p-4 space-y-3 flex flex-col max-h-[30vh] `}>
                ...
                <div className='flex-1 min-w-0'>
                  <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2'>
                    ...
                    <div className='flex items-center gap-2 flex-wrap'>
                      ...
                      />
                      {user.isPlusMember && (
                        <span className='px-2 py-0.5 rounded-full text-[10px] bg-amber-100 text-amber-700 whitespace-nowrap'>
                          Plus
                        </span>
                      )}
                    </div>
              ...
              <div className='flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 text-xs mt-2'>
