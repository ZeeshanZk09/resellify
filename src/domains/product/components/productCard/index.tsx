...
export default function ProductCard({
  ...
  return (
    ...
    >
      ...
      <button
        className="absolute top-12 right-3 z-10 p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white sm:hidden"
