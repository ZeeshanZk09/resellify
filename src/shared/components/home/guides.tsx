...
import { clone, copy_variables, install, prisma, run, variables } from '@/shared/lib/guides';
    ...
    <section id='guides' className='pt-20'>
      ...
      <ol className='list-decimal list-inside   space-y-5 mt-6'>
        ...
        <li>
          ...
          <p className='mt-3 text-zinc-600 dark:text-zinc-400'>
            To configure the environment variables, create a `.env` file in the root of the project
