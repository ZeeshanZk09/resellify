...
const CheckBox = ({ text, isChecked, onClick }: TProps) => {
  return (
    <div
      className={cn(
        "flex items-center gap-2 cursor-pointer transition-all duration-400",
        {
    ...
    >
      ...
      >
        <CheckIcon
          ...
          strokeWidth={1.5}
          className={cn(
            "fill-none stroke-white opacity-0 transition-opacity duration-400",
            {
      ...
      <span
        className={cn(
          "text-gray-700 select-none text-sm transition-colors duration-500",
          {
